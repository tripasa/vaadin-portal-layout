...
/**
 * Interface for the objects that might be stored in the portal.
 * Exists mostly for making easier the size calculations of Portlets and PortalDropPositioners. 
 * @author p4elkin
 * 
 */
public interface PortalObjectSizeHandler {
  ...
  /**
   * Get pixel amount needed by the component to
   * display its fixed part. If the component has relative height
   * then only size of the header will be considered.
  ...
  /**
   * Set height pixel value of the portal object (Portlet or PortalDropPositioners).
   * @param height New height value.
   */
  public void setWidgetHeight(int height);
  
  /**
   * Set width pixel value of the portal object (Portlet or PortalDropPositioners).
   * @param width New width value.
   */
