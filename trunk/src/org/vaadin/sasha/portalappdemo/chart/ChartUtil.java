...
public class ChartUtil {
  ...
  private static final String[] captions = {"Basic Chart", "Level Chart", "Regression Chart"};
  
  public static String getChartCaptionByIndex(int i)
  {
  ...
  private static JFreeChart createchart(CategoryDataset dataset) {
    ...
    GradientPaint gp0 = new GradientPaint(0.0f, 0.0f, Color.blue, 0.0f, 0.0f,
        new Color(0, 0, 64));
    GradientPaint gp1 = new GradientPaint(0.0f, 0.0f, Color.green, 0.0f, 0.0f,
        new Color(0, 64, 0));
  ...
  public static JFreeChartWrapper getLevelChart() {
  ...
  public static Component getChartByIndex(int index)
  {
    int offsetIndex = index % captions.length;
    JFreeChartWrapper chart = null;
    switch (offsetIndex)
    {
    case 1:
      chart = getLevelChart();
  ...
  public static JFreeChartWrapper regressionChart() {
    ...
    JFreeChart scatterPlot = ChartFactory.createScatterPlot("Regression", "X",
        "Y", ds, PlotOrientation.HORIZONTAL, true, false, false);
